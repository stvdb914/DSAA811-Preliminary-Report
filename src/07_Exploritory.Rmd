...
```{r numericals, fig.width = 15, fig.height = 20, include=TRUE}
  ...
  theme_bw()
```
From this we can see that swimmers are optimal when they are unfer the age of 40 and smaller than 100 kilograms in general, across all the Olympics.
